...
app.use(
  "/adminImages",
  express.static(path.join(process.cwd(), "public", "adminImages"))
);
app.use(
  "/userImages",
...
app.use(
  "/marksheetImages",
  express.static(path.join(process.cwd(), "public", "marksheetImages"))
);
app.use(
  "/QRImages",
  express.static(path.join(process.cwd(), "public", "QRImages"))
);
